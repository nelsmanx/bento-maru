...
// 	const productInCart = cartStore.cart.find(product => product.id === props.id);
...
<template>
	<div class="card" :class="$attrs.class">
		<div class="card__inner">
			<span v-if="isNew" class="card__badge">NEW</span>
			<picture class="card__picture" @click="isOpen = !isOpen">
			...
			<div class="card__info">
				<div class="card__title-and-weight">
					...
					<p class="card__weight">{{ props.weight }} г.</p>
				</div>
				<p class="card__desc">{{ props.description }}</p>
				<div class="card__price-and-actions">
					<div class="card__price">
						<div class="card__price-actual">{{ props.priceActual }} ₽</div>
						<div v-if="props.priceOld" class="card__price-old">{{ props.priceOld }} руб</div>
					</div>
					<div class="card__actions">
						<button @click="$emit('toggle-fav')"
							:class="{ 'is-active': props.isFav }"
							class="card__button-fav">
						</button>

						<button v-if="!props.quantity"
							@click="$emit('increase-quantity', props.id)"
