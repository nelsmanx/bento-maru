...
<template>
	<header class="header" :class="{ 'is-fixed': headerIsFixed }" ref="header">
	...
	<div class="header-stub" :style="`height: ${headerHeight}px`"></div>
</template>
